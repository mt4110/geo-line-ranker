...
- Release candidate decisions use `just release-readiness` to review the flow, `just mvp-acceptance` as the fixed gate, and `just data-quality-doctor` as supplementary evidence.
