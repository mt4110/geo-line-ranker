...
info "profile_packs_dir=${PROFILE_PACKS_DIR:-unset}"
info "profile_id=${PROFILE_ID:-unset}"
info "profile_fixture_set_id=${PROFILE_FIXTURE_SET_ID:-unset}"
info "ranking_config_dir=${RANKING_CONFIG_DIR:-unset}"
info "fixture_dir=${FIXTURE_DIR:-unset}"
